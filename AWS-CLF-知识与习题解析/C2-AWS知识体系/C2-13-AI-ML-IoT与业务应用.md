...
项目资料当前把 Amazon Q 列入 AI/ML 范围。CLF 层级应把它理解为 AWS 的生成式 AI 助手/企业助手产品家族，而不是传统数据库、监控或 IAM 服务。

由于生成式 AI 产品更新较快，本章不固定易过期的产品版本、套餐和具体功能清单，考试前应按当前官方范围复核。

## 12-★★★-AWS-IoT-Core

IoT = Internet of Things = 物联网。

IoT Core 让大量设备安全连接 AWS，并进行消息交换、规则处理和后端集成。

GlobalShop 物流仓库可能有温度传感器：
