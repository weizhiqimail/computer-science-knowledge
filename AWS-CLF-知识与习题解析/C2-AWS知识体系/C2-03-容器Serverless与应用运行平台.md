...
```text
500 个 Product Container
300 个 Order Container
100 个 Payment Container
```
...
Higher Infrastructure Abstraction
```
...
```text
必须 24x7 为一台 Server 付运行费
```

经典 Lambda Function 通常围绕：

```text
Request / Invocation
+
Execution Duration / Allocated Resources
```
...
经典 Lambda Function 不是无限时长的传统服务器进程。

当前 AWS Lambda Functions 的单次 Invocation 有最大执行时长限制。
...
因此本章把 Lambda Function 作为考试和基础架构学习主线。
...
Elastic Beanstalk 与 ECS/EKS 都可能最终运行 Web Application。
...
[AWS 官方：CLF-C02 In-Scope AWS Services](https://docs.aws.amazon.com/aws-certification/latest/cloud-practitioner-02/clf-02-in-scope-services.html)
...
[AWS 官方文档：What is Amazon EKS?](https://docs.aws.amazon.com/eks/latest/userguide/)
...
[AWS 官方文档：AWS Fargate with Amazon EKS](https://docs.aws.amazon.com/eks/latest/userguide/fargate.html)

AWS Lambda：

[AWS 官方文档：What is AWS Lambda?](https://docs.aws.amazon.com/lambda/latest/dg/welcome.html)
